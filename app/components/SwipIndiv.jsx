...
const SwipIndiv = () => {
  return (
    <div data-swiper-slide-index="1" class="mx-0 my-[24px] pl-[40px] pr-0 py-[40px] box-border flex-shrink-0 w-[1223px] h-full relative [transition-property:opacity] flex [transform:translate3d(-1223px,_0px,_0px)] [backface-visibility:hidden] pointer-events-auto min-h-[770px] text-[rgb(255,_254,_248)] flex-col opacity-100 duration-300 ">
    <h2 class="m-0 p-0 box-border font-[LabilGrotesk,_sans-serif] font-extrabold text-[90px] leading-[85%] tracking-[-0.02em] uppercase max-w-[940px] mb-auto">
    ...
    <div class="m-0 p-0 box-border flex justify-between items-center">
        <div class="m-0 p-0 box-border font-[LabilGrotesk,_sans-serif] font-medium text-[24px] leading-[130%] tracking-[0.01em] max-w-[530px]">
            <div class="m-0 p-0 box-border">
                <div class="m-0 p-0 box-border inline-flex">
                    <span class="m-0 p-0 box-border opacity-100 transform-none">V</span>
                    <span class="m-0 p-0 box-border opacity-100 transform-none">e</span>
        ...
        <div class="m-0 p-[24px] box-border flex items-center bg-[rgb(255,_254,_248)] rounded-tl-[16px] rounded-br-none rounded-tr-none rounded-bl-[16px] min-w-[246px]">
            ...
            <div class="m-0 p-0 box-border">
                <div class="m-0 p-0 box-border font-[LabilGrotesk,_sans-serif] font-bold text-[16px] tracking-[normal] text-[rgb(17,_26,_41)] leading-[100%] uppercase">
                    <div class="m-0 p-0 box-border">
                        <div class="m-0 p-0 box-border inline-flex">
                            <span class="m-0 p-0 box-border opacity-100 transform-none">M</span>
                            <span class="m-0 p-0 box-border opacity-100 transform-none">i</span>
                ...
                <div class="m-0 p-0 box-border font-[LabilGrotesk,_sans-serif] font-medium text-[16px] tracking-[0.01em] text-[rgb(17,_26,_41)] leading-[100%]">
                    <div class="m-0 p-0 box-border">
                        <div class="m-0 p-0 box-border inline-flex">
                            <span class="m-0 p-0 box-border opacity-100 transform-none">№</span>
                        </div>
